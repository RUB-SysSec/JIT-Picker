...
public struct Fuzzilli_Protobuf_DifferentialHash {
  ...
  public var allowInnerScope: Bool = false
...
extension Fuzzilli_Protobuf_DifferentialHash: @unchecked Sendable {}
...
extension Fuzzilli_Protobuf_DifferentialHash: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.allowInnerScope) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.allowInnerScope != false {
      try visitor.visitSingularBoolField(value: self.allowInnerScope, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Fuzzilli_Protobuf_DifferentialHash, rhs: Fuzzilli_Protobuf_DifferentialHash) -> Bool {
    if lhs.allowInnerScope != rhs.allowInnerScope {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
